...
const CardModel = ({ name, urlPokemon }) => {
    ...
    return (
        <>
            <div onClick={() => handleModal()} className='border-2 rounded p-3 space-y-2 flex justify-center items-center flex-col cursor-pointer transition-all active:scale-95 hover:border-stone-400'>
